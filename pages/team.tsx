...
export default function TeamPage() {
  ...
  // Helper: czy dany wiersz można selekcjonować do nadawania uprawnień
  ...
  // Lista membershipów, które można zaznaczać (dla "Select all" i filtracji)
  ...
  async function load() {
    ...
    try {
      ...
      // usuń zaznaczenia, które nie istnieją w aktualnej tabeli
  ...
  // Dodatkowo: usuń zaznaczenia, które nie są już selekcjonowalne (np. zmieniła się rola/me)
  useEffect(() => {
              ...
              <table className="min-w-full text-sm">
                <thead className="text-left text-gray-600">
                  <tr className="border-b">
                    {/* MULTI-SELECT HEADER (only selectable) */}
