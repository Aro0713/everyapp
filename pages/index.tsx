    ...
    <main className="min-h-screen bg-ew-bg text-ew-primary">
      ...
      <section className="relative overflow-hidden bg-ew-primary text-white">
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-6 py-20 md:grid-cols-12 md:py-28">
          <div className="md:col-span-7">
            ...
            {/* Strategic AI callout (NOWE KLUCZE) */}
            <div className="mt-6 max-w-2xl rounded-3xl border border-white/10 bg-white/5 p-5">
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-ew-accent" />
                <p className="text-sm font-semibold">{t(lang, "landingAiAssistantTitle" as any)}</p>
              </div>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              {["heroProof1", "heroProof2", "heroProof3"].map((k) => (
          ...
          <div className="md:col-span-5">
            ...
            <div className="mt-4 text-xs text-white/55">{t(lang, "mockDisclaimer")}</div>
          </div>
        </div>
      </section>

      {/* VALUE PROPS (NOWE KLUCZE) */}
      <section className="mx-auto max-w-6xl px-6 py-12">
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={it.t} className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
              <p className="text-sm font-semibold">{t(lang, it.t as any)}</p>
              <p className="mt-2 text-sm text-gray-600 leading-relaxed">{t(lang, it.d as any)}</p>
              <div className="mt-4 h-px bg-gray-100" />
              <div className="mt-4 rounded-2xl bg-ew-accent/10 px-4 py-3 text-sm font-semibold text-ew-primary">
                {t(lang, "featuresNote")}
              </div>
            </div>
          ))}
      ...
      <section className="mx-auto max-w-6xl px-6 pb-12">
        <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <p className="text-sm text-gray-500">{t(lang, "integrationsSubtitle")}</p>
          </div>
      ...
      <section id="funkcje" className="mx-auto max-w-6xl px-6 py-14 md:py-18">
        <div className="flex flex-col gap-3">
          ...
          <p className="max-w-3xl text-gray-600 leading-relaxed">{t(lang, "featuresSubtitle")}</p>
        </div>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {features.map((f) => (
            <div
              key={f.title}
              className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:shadow"
            >
              <h3 className="text-lg font-semibold">{t(lang, f.title as any)}</h3>
              <p className="mt-2 text-gray-600 leading-relaxed">{t(lang, f.desc as any)}</p>
      ...
      {/* HOW IT WORKS */}
      <section id="jak-dziala" className="mx-auto max-w-6xl px-6 py-14 md:py-18">
        <h2 className="text-3xl font-extrabold tracking-tight md:text-4xl">{t(lang, "howTitle")}</h2>
        <p className="mt-3 max-w-3xl text-gray-600 leading-relaxed">{t(lang, "howSubtitle")}</p>

        <div className="mt-10 grid gap-6 md:grid-cols-4">
          {steps.map((s, idx) => (
            <div
              key={s.k}
              className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm transition hover:shadow"
            >
      ...
      <section className="mx-auto max-w-6xl px-6 py-14 md:py-18">
        <div className="grid gap-6 md:grid-cols-12">
          <div className="md:col-span-7">
            ...
            <p className="mt-3 max-w-3xl text-gray-600 leading-relaxed">{t(lang, "trustDesc")}</p>
          ...
          <div className="md:col-span-5">
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-gray-600 leading-relaxed">{t(lang, "metricsDesc")}</p>

              <div className="mt-6 grid gap-3">
                {["metricsRow1", "metricsRow2", "metricsRow3", "metricsRow4"].map((k) => (
                  <div
                    key={k}
                    className="flex items-center justify-between rounded-2xl bg-ew-accent/10 px-4 py-3"
                  >
                    <span className="text-sm font-semibold text-gray-800">{t(lang, k as any)}</span>
        ...
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
          <div className="grid gap-10 md:grid-cols-12 md:items-center">
            <div className="md:col-span-7">
              ...
              <p className="mt-4 max-w-2xl text-white/80 leading-relaxed">{t(lang, "cta2Desc")}</p>
            ...
            <div className="md:col-span-5">
              <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
                ...
                <p className="mt-2 text-sm text-white/75 leading-relaxed">{t(lang, "ctaBoxDesc")}</p>
